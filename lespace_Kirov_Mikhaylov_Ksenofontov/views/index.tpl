% rebase('layout.tpl', title='Rockets', year=year)

<h1>Rockets that conquer space and lead us to new knowledge</h1>
<html>
 <head>
 <meta charset="utf-8">
  <style>
...
SpaceX conducted Falcon Heavy's maiden launch on 6 February 2018, at 20:45 UTC. The rocket carried a Tesla Roadster belonging to SpaceX founder Elon Musk, with a dummy dubbed "Starman" in the driver's seat, as a dummy payload. The second Falcon Heavy launch occurred on 11 April 2019 and all three booster rockets successfully returned to Earth. The third Falcon Heavy launch successfully occurred on 25 June 2019. Since then, Falcon Heavy has been certified for the National Security Space Launch (NSSL) program.</p>
 <h2><a href="https://www.spacex.com/vehicles/falcon-9/">Falcon 9</a></h2>
  <a href="https://www.spacex.com/vehicles/falcon-9/"><img width="250px" height="250px" src ="static/content/Falcon_9.jpg" class ="leftpic"></a>
  <p>Falcon 9 is a partially reusable two-stage-to-orbit medium-lift launch vehicle designed and manufactured by SpaceX in the United States. Both the first and second stages are powered by SpaceX Merlin engines, using cryogenic liquid oxygen and rocket-grade kerosene (RP-1) as propellants. Its name is derived from the fictional Star Wars spacecraft, the Millennium Falcon, and the nine Merlin engines of the rocket's first stage. The rocket evolved with versions v1.0 (2010–2013), v1.1 (2013–2016), v1.2 "Full Thrust" (2015–present), including the Block 5 Full Thrust variant, flying since May 2018. Unlike most rockets in service, which are expendable launch systems, since the introduction of the Full Thrust version, Falcon 9 is partially reusable, with the first stage capable of re-entering the atmosphere and landing vertically after separating from the second stage. This feat was achieved for the first time on flight 20 in December 2015.
